        ...
        <div class="col-md-12">
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form id="form" action="/gd/subject/verify" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="col-sm-3" name="status" id="status">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        [@permission permission = "gd:subject:verify:list" userId="${USER.id}" type="BOOLEAN";isOk]
                                        [#if isOk]
                                        <button type="button" class="btn  btn-info btn-lg  margin"
                                                onclick="CommonUtil.loadView('/gd/subject/verify/list')">返回
                                        </button>
                                        [/#if]
                                        [/@permission]
